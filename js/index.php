...
<article id="home" class="content">
    ...
    <div id="info"> 
      ...
      <div id="barrainfo"><br> <center>  </center></div> 
    </div>
    <div id="slider">  
          <div class="recomendados"> Recomendados por Ubicandote </div>
     ...
     <div id="slider2">  
          <div class="recomendados"> Promociones Destacadas </div>
          <a href="#" id="prev" class="prev-posts"  > <i class="icon-chevron-left"> </i> </a>
          <div class="carousel">  
                    <ul id="carousel">
                    <?  
                    while ($slider2 = @mysql_fetch_assoc($query_slider2)){ 
                      echo '
                        <li>  <div style="float:left;width:35%;padding:0px;"> <img class="bordeado" width="100%" src="'.$slider2['imgnube'].'" alt="" title="">   </div>
                              <div style="float:right;width:60%;padding:3px;">
                                  <strong>'.$slider2['nombre'].' </strong> <br>
                                  <div class="tags"> <i class="icon-tag"></i> '.$slider2['catname'].'</a>   </div> <br>
                                  <a href="perfil.php?id='.$slider2['idperfil'].'" title="" class="read-more"> Ver Perfil » </a>  <br>
                              </div>
                        </li>
                      '; 
                    }
          ...
          <a href="#" id="next" class="next-posts"  > <i class="icon-chevron-right"></i></a>  
    </div> 
...
<?php include("footer.php");   ?> 
  <script type="text/javascript">
    ...
    jQuery(document).ready(function ($) {  
                ...
                SM = new SimpleModal({"hideHeader":true, "closeButton":false, "btn_ok":"Cerrar Ventana", "width":650, "offsetTop:":140});
                SM.show({
                          "model":"alert",
                          <?   echo '"contents": "';
                              $cat; 
